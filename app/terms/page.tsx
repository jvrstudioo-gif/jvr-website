  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-12">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <p className="text-center">Last Updated: [September 27, 2025]</p>

        {/* Customer-Friendly Summary */}
        <section className="space-y-3">
          <h2 className="text-2xl font-semibold">Customer-Friendly Summary</h2>
          <ul className="list-disc list-inside space-y-2">
            ...
            <li><strong>Installation:</strong> If glass is cracked, chipped, or aged, tint may not cure properly. Layered tint voids warranty. After installation, do not roll windows down for 3–5 days or warranty is void.</li>
            <li><strong>Vinyl/Wraps:</strong> If paint isn’t in good condition (sun-damaged, scratched, chipped), vinyl may not stick and warranty is void. Imperfections will still show through.</li>
            <li>All sales are final unless there’s an installation mistake. Special orders require a 50% non-refundable deposit.</li>
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold">Full Terms &amp; Conditions</h2>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-xl font-bold">2. Services Provided</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">3. Customer Responsibility (Tint Laws)</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">4. Tint Removal Disclaimer</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">5. Tint Installation Disclaimer</h3>
              <ul className="list-disc list-inside space-y-2">
                <li>
            ...
            <div>
              <h3 className="text-xl font-bold">6. Vinyl &amp; Wrap Disclaimer</h3>
              <ul className="list-disc list-inside space-y-2">
            ...
            <div>
              <h3 className="text-xl font-bold">7. Quality &amp; Warranty</h3>
              <ul className="list-disc list-inside space-y-2">
            ...
            <div>
              <h3 className="text-xl font-bold">8. Payments &amp; Refunds</h3>
              <p>
                Accepted payments: Square, Cash App, Venmo, Zelle, and cash. Refunds are only granted if installation quality is poor due to our error.
                Refunds are not issued for change of mind, dissatisfaction with color, or customer misuse.
                For materials not stocked (special orders), a 50% non-refundable deposit is required; if canceled, the deposit is not refunded.
              </p>
            </div>

            <div>
              <h3 className="text-xl font-bold">9. Liability Limitations</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">10. Website Use</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">11. Privacy &amp; Data</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">12. Photo Release</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">13. Refusal of Service</h3>
            ...
            <div>
              <h3 className="text-xl font-bold">14. Dispute Resolution</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-bold">15. Modifications to Terms</h3>
              <p>
